    ...
    <div class="container" style="padding-top:0px">
               ...
               <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="edit">
                    ...
                    <div class="codo_edit_profile">
                        ...
                        <div color=white class="codo_edit_profile_title">
                            <div style="color: #fff;" class=""><span>Edit Profile</span></div>
                          ...
                          <div class="col-12 col-sm-6 col-md-8">
                            ...
                            {foreach from=$custom_fields item=field}
                                ...
                                <div class="form-group" id="custom_field_{$field.id}">
                                    ...
                                    {if $field.title}
                                        <label style="color: #fff;" class="control-label" for="{$field.title}" >{$field.title}</label>
                                    {/if}
                                <div>
                    ...
                    <div class="codo_edit_profile" style="padding: 0">
                        ...
                        <div class="codo_edit_profile_title">
                            <div style="color: #fff;" class=""><span>{_t("Change password")}</span></div>
        ...
        <div class="tab-pane fade" id="preferences">
                ...
                <div class="codo_edit_profile">
                    ...
                    <div class="codo_edit_profile_title">
                        <div style="color: #fff;" class=""><span>General</span></div>
                    </div>
                    <br/>
            ...
            <div class="col-md-4 profile-user-statistics-right">
                ...
                <div class="codo_profile profile-user-statistics-right-inner" id="">
                    ...
                    <div class="codo_user_details">
                        ...
                        <div style="color:#9f9f9f;"> {_t("Joined :")} <span style="float:right;color:#fff;font-weight:bold">{$user->created|get_pretty_time}</span>
                        </div>
                        <div style="color:#9f9f9f;">
                            {_t("Last login :")} <span style="float:right;color:#fff;font-weight:bold">{if $user->last_access eq 0}{_t('never')}{else}{$user->last_access|get_pretty_time}{/if}</span>
                        </div>
