    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="codo_widget">
                ...
                <div style="color: #fff;" class="codo_widget-header">
                    {_t("Create Topic")}
                </div>

                <div class="codo_widget-content">
                    <form style="color: #000;" id="codo_new_reply_post"  method="POST" class="" role="form">
                        ...
                        <div id="codo_new_reply" class="codo_new_reply">
                            ...
                            <div class="codo_reply_box" id="codo_reply_box">
                                ...
                                <div style="color: #fff;" class="codo_new_reply_preview" id="codo_new_reply_preview_container">
                        ...
                        <div style="color: #fff;" class="form-group" id="alter_topic_status" style="display: none">
                        ...
                        <div style="color: #fff;" style= class="form-group perm_auto_close" style="display: none">
