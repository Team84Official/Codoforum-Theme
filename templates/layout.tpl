...
<html>
    ...
    <body>
        ...
        <div class="CODOFORUM">
            ...
            <nav style="background-color: #000;" id="nav" class="navbar navbar-expand-lg navbar-clean fixed-top" role="navigation">
                        ...
                        <ul class="nav navbar-nav ml-auto">
                            {if isset($can_search) and $can_search}
                                <li class="dropdown d-none d-sm-block global_search">
                                   <input style="color: #fff; background-color: #000" class="codo_global_search_input codo_global_search_head_input" type="text" placeholder="{_t('Search')}" />
                                </li>
                                <li class="dropdown d-none d-sm-block global_search">
                            ...
                            {if $I->loggedIn()}
                                ...
                                <li class="nav-item codo_menu_user dropdown">
                                    ...
                                    <a class="nav-link codo_menu_user_img" data-toggle="dropdown"><img  src="{$I->avatar}" />
                                        <span style="color: #fff;" class="codo_user_name_span">{$I->name}</span>
                                    </a>
                                    <div class="dropdown-menu codo_menu_user_container" role="menu" aria-labelledby="dLabel">

                                       <a style="color: #fff;" class="dropdown-item" href="{$profile_url}"><i class="glyphicon glyphicon-user"></i>
                                                <span>{_t("View Profile")}</span></a>
                                        <a style="color: #fff;" class="dropdown-item" href="{$profile_url}/{$I->id}/edit"><i class="glyphicon glyphicon-pencil"></i>
                                                <span>{_t("Edit")}</span></a>
                                        <a style="color: #ff0000;" class="dropdown-item" href="{$logout_url}"><i
